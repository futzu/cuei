...
func(dscptr *SpliceDescriptor) Decoder(gob *gob.Gob, tag uint8, length uint8)  {
	switch tag {
	case 0:
        dscptr.Tag = 0
...
func (dscptr *SpliceDescriptor) Audio(gob *gob.Gob, tag uint8, length uint8) {
	dscptr.Tag = tag
...
func (dscptr *SpliceDescriptor) Avail(gob *gob.Gob, tag uint8, length uint8) {
	dscptr.Tag = tag
	dscptr.Length = length
	dscptr.Identifier = gob.Ascii(32)
...
func (dscptr *SpliceDescriptor) DTMF(gob *gob.Gob, tag uint8, length uint8) {
	dscptr.Tag = tag
	dscptr.Length = length
	dscptr.Identifier = gob.Ascii(32)
...
func (dscptr *SpliceDescriptor) Time(gob *gob.Gob, tag uint8, length uint8) {
	dscptr.Tag = tag
	dscptr.Length = length
	dscptr.Identifier = gob.Ascii(32)
...
func (dscptr *SpliceDescriptor) Segmentation(gob *gob.Gob, tag uint8, length uint8) {
	dscptr.Tag = tag
	dscptr.Length = length
	dscptr.Identifier = gob.Ascii(32)
...
func (dscptr *SpliceDescriptor) decodeSegFlags(gob *gob.Gob) {
...
func (dscptr *SpliceDescriptor) decodeSegCmpnts(gob *gob.Gob) {
	ccount := gob.UInt8(8)
...
func (dscptr *SpliceDescriptor) decodeSegmentation(gob *gob.Gob) {
